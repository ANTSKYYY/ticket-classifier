...
def main():
    ...
    # 2. Data loading and preparation (Phase 1)
    print("\n📂 Loading normal data...")
    ...
    # 3. Loading adversarial data (Phase 2)
    print("\n⚔️  Preparing adversarial data...")
    ...
    # ==========================================
    # 🎓 PHASE 1: Curriculum Learning (Normal data)
    # ==========================================
    print("\n🎓 Starting Phase 1 (Easy data)...")
